const TRANSLATIONS = {
  ru: {
    ...
    "skill.subtitle": "Дай агенту управлять Maestro — Claude Code, Codex, Hermes или OpenClaw.",
    "skill.s1.title": "Поставь команду `care`",
    "skill.s1.desc": "Одна команда настраивает CLI Maestro, которым будет управлять навык.",
    "skill.s2.title": "Установи навык",
    "skill.s2.desc": "Выбери агента — навык встанет в его каталог skills (~/.<агент>/skills/maestro).",
    "skill.aside.title": "После установки",
    "skill.req1": "Нужна рабочая команда care (шаг выше)",
    "skill.req2": "Вызови /maestro или опиши задачу словами",
  ...
  en: {
    ...
    "skill.subtitle": "Let your agent drive Maestro — Claude Code, Codex, Hermes, or OpenClaw.",
    "skill.s1.title": "Get the `care` command",
    "skill.s1.desc": "One command sets up the Maestro CLI your skill will drive.",
    "skill.s2.title": "Install the skill",
    "skill.s2.desc": "Pick your agent — the skill lands in its skills directory (~/.<agent>/skills/maestro).",
    "skill.aside.title": "After install",
    "skill.req1": "Requires a working care command (step above)",
    "skill.req2": "Invoke /maestro or describe a task in words",
