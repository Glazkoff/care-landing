const TRANSLATIONS = {
  ru: {
    ...
    "skill.s2.desc": "Готово — вызови /care-cli или просто опиши задачу для MAESTRO: навык подхватится сам.",
  ...
  en: {
    ...
    "skill.s2.desc": "Done — invoke /care-cli or just describe a MAESTRO task; the skill triggers itself.",
