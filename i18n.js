const TRANSLATIONS = {
  ru: {
    ...
    "install.subtitle": "Три команды — и MAESTRO CARE запущен. Без сборки.",
    "install.s1.title": "Установи зависимости",
    "install.s1.desc": "uv создаст окружение и поставит весь стек MAESTRO CARE.",
    "install.s2.title": "Укажи доступ к модели",
    "install.s2.desc": "care init создаст файл .env: адрес сервиса, ключ и название модели.",
    "install.s3.title": "Запусти MAESTRO CARE",
  ...
  en: {
    ...
    "install.subtitle": "Three commands and MAESTRO CARE is running. No build step.",
    "install.s1.title": "Install dependencies",
    "install.s1.desc": "uv creates the environment and installs the whole MAESTRO CARE stack.",
    "install.s2.title": "Point MAESTRO CARE at a model",
    "install.s2.desc": "care init creates a .env file: service URL, API key, and model name.",
    "install.s3.title": "Launch MAESTRO CARE",
