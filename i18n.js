const TRANSLATIONS = {
  ru: {
    ...
    "p2.desc": "Модуль CARL запускает шаги в изолированной песочнице и показывает прогресс в реальном времени — виден каждый шаг агента.",
    "p2.chip1": "Песочница",
  ...
  en: {
    ...
    "p2.desc": "The CARL module runs the steps in an isolated sandbox and streams progress in real time — you see every step the agent takes.",
    "p2.chip1": "Sandbox",
