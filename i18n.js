const TRANSLATIONS = {
  ru: {
    ...
    "install.models.list": "Qwen3-Coder · GLM-4.6 · Kimi K2",
    "install.models.tip": "Выбирай модель с уверенным tool-calling и контекстом от 32K — на ней MAGE собирает цепочки стабильнее.",
  ...
  en: {
    ...
    "install.models.list": "Qwen3-Coder · GLM-4.6 · Kimi K2",
    "install.models.tip": "Pick a model with solid tool-calling and a 32K+ context — MAGE assembles chains far more reliably on it.",
